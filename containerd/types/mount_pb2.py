...
_MOUNT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="type",
            full_name="containerd.types.Mount.type",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="source",
            full_name="containerd.types.Mount.source",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="target",
            full_name="containerd.types.Mount.target",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="options",
            full_name="containerd.types.Mount.options",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
