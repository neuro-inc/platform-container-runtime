...
_PROCESS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="container_id",
            full_name="containerd.v1.types.Process.container_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="containerd.v1.types.Process.id",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="pid",
            full_name="containerd.v1.types.Process.pid",
            index=2,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="status",
            full_name="containerd.v1.types.Process.status",
            index=3,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="stdin",
            full_name="containerd.v1.types.Process.stdin",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="stdout",
            full_name="containerd.v1.types.Process.stdout",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="stderr",
            full_name="containerd.v1.types.Process.stderr",
            index=6,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="terminal",
            full_name="containerd.v1.types.Process.terminal",
            index=7,
            number=8,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="exit_status",
            full_name="containerd.v1.types.Process.exit_status",
            index=8,
            number=9,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="exited_at",
            full_name="containerd.v1.types.Process.exited_at",
            index=9,
            number=10,
            type=11,
            cpp_type=10,
...
_PROCESSINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="pid",
            full_name="containerd.v1.types.ProcessInfo.pid",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="info",
            full_name="containerd.v1.types.ProcessInfo.info",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
ProcessInfo = _reflection.GeneratedProtocolMessageType(
    "ProcessInfo",
    (_message.Message,),
    {
