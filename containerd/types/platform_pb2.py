...
_PLATFORM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="os",
            full_name="containerd.types.Platform.os",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            serialized_options=b"\342\336\037\002OS",
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name="architecture",
            full_name="containerd.types.Platform.architecture",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="variant",
            full_name="containerd.types.Platform.variant",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
