...
_PLUGIN_EXPORTSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="containerd.services.introspection.v1.Plugin.ExportsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="containerd.services.introspection.v1.Plugin.ExportsEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_PLUGIN = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="type",
            full_name="containerd.services.introspection.v1.Plugin.type",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="containerd.services.introspection.v1.Plugin.id",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="requires",
            full_name="containerd.services.introspection.v1.Plugin.requires",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="platforms",
            full_name="containerd.services.introspection.v1.Plugin.platforms",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="exports",
            full_name="containerd.services.introspection.v1.Plugin.exports",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="capabilities",
            full_name="containerd.services.introspection.v1.Plugin.capabilities",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="init_err",
            full_name="containerd.services.introspection.v1.Plugin.init_err",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
...
_PLUGINSREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="filters",
            full_name="containerd.services.introspection.v1.PluginsRequest.filters",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_PLUGINSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="plugins",
            full_name="containerd.services.introspection.v1.PluginsResponse.plugins",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_SERVERRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="uuid",
            full_name="containerd.services.introspection.v1.ServerResponse.uuid",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b"\342\336\037\004UUID",
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_PLUGIN.fields_by_name[
    "platforms"
].message_type = containerd_dot_types_dot_platform__pb2._PLATFORM
...
Plugin = _reflection.GeneratedProtocolMessageType(
    "Plugin",
    (_message.Message,),
    {
        "ExportsEntry": _reflection.GeneratedProtocolMessageType(
            "ExportsEntry",
            (_message.Message,),
            {
...
PluginsRequest = _reflection.GeneratedProtocolMessageType(
    "PluginsRequest",
    (_message.Message,),
    {
...
PluginsResponse = _reflection.GeneratedProtocolMessageType(
    "PluginsResponse",
    (_message.Message,),
    {
