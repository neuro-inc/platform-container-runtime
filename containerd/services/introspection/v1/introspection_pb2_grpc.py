...
from containerd.services.introspection.v1 import (
    introspection_pb2 as containerd_dot_services_dot_introspection_dot_v1_dot_introspection__pb2,
)
