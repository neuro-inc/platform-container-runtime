...
_FORWARDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="envelope",
            full_name="containerd.services.events.ttrpc.v1.ForwardRequest.envelope",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_ENVELOPE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="containerd.services.events.ttrpc.v1.Envelope.timestamp",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="namespace",
            full_name="containerd.services.events.ttrpc.v1.Envelope.namespace",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="topic",
            full_name="containerd.services.events.ttrpc.v1.Envelope.topic",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="event",
            full_name="containerd.services.events.ttrpc.v1.Envelope.event",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
