...
_SNAPSHOTPREPARE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="containerd.events.SnapshotPrepare.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="parent",
            full_name="containerd.events.SnapshotPrepare.parent",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_SNAPSHOTCOMMIT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="containerd.events.SnapshotCommit.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="containerd.events.SnapshotCommit.name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_SNAPSHOTREMOVE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="containerd.events.SnapshotRemove.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
SnapshotPrepare = _reflection.GeneratedProtocolMessageType(
    "SnapshotPrepare",
    (_message.Message,),
    {
...
SnapshotCommit = _reflection.GeneratedProtocolMessageType(
    "SnapshotCommit",
    (_message.Message,),
    {
...
SnapshotRemove = _reflection.GeneratedProtocolMessageType(
    "SnapshotRemove",
    (_message.Message,),
    {
