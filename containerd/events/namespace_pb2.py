...
_NAMESPACECREATE_LABELSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="containerd.events.NamespaceCreate.LabelsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="containerd.events.NamespaceCreate.LabelsEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_NAMESPACECREATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="containerd.events.NamespaceCreate.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="labels",
            full_name="containerd.events.NamespaceCreate.labels",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_NAMESPACEUPDATE_LABELSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="containerd.events.NamespaceUpdate.LabelsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="containerd.events.NamespaceUpdate.LabelsEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_NAMESPACEUPDATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="containerd.events.NamespaceUpdate.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="labels",
            full_name="containerd.events.NamespaceUpdate.labels",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_NAMESPACEDELETE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="containerd.events.NamespaceDelete.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
NamespaceCreate = _reflection.GeneratedProtocolMessageType(
    "NamespaceCreate",
    (_message.Message,),
    {
...
NamespaceUpdate = _reflection.GeneratedProtocolMessageType(
    "NamespaceUpdate",
    (_message.Message,),
    {
        "LabelsEntry": _reflection.GeneratedProtocolMessageType(
...
NamespaceDelete = _reflection.GeneratedProtocolMessageType(
    "NamespaceDelete",
    (_message.Message,),
    {
