...
_IMAGECREATE_LABELSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="containerd.services.images.v1.ImageCreate.LabelsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="containerd.services.images.v1.ImageCreate.LabelsEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_IMAGECREATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="containerd.services.images.v1.ImageCreate.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="labels",
            full_name="containerd.services.images.v1.ImageCreate.labels",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_IMAGEUPDATE_LABELSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="containerd.services.images.v1.ImageUpdate.LabelsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="containerd.services.images.v1.ImageUpdate.LabelsEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_IMAGEUPDATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="containerd.services.images.v1.ImageUpdate.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="labels",
            full_name="containerd.services.images.v1.ImageUpdate.labels",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_IMAGEDELETE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="containerd.services.images.v1.ImageDelete.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
ImageCreate = _reflection.GeneratedProtocolMessageType(
    "ImageCreate",
    (_message.Message,),
    {
...
ImageUpdate = _reflection.GeneratedProtocolMessageType(
    "ImageUpdate",
    (_message.Message,),
    {
        "LabelsEntry": _reflection.GeneratedProtocolMessageType(
...
ImageDelete = _reflection.GeneratedProtocolMessageType(
    "ImageDelete",
    (_message.Message,),
    {
